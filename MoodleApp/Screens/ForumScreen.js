    ...
    return(
            ...
            <View style={{ flex: 1 }}>
                <View style={{ backgroundColor: 'white', flexDirection: 'row' ,marginTop:10}}>
                     ...
                     <Text style={{ color: '#000080', marginTop: 10, marginBottom: 0, fontSize: 20, fontWeight: 'bold',textAlign:'center' }}>Forum</Text>
                </View>
                ...
                <View style={{ flex: 6, backgroundColor: '#000080', }}>
                    ...
                    <DropDownPicker
                     containerStyle={{width: 390, height: 50 , paddingLeft:20, backgroundColor: 'white',zIndex: 1000, elevation: 1000,}}
                       placeholder="Filter By course"
                        ...
                        <Text style={{ marginLeft: 20, color: '#000080', marginTop: 10, marginBottom: 5, fontSize: 15, fontWeight: 'bold', alignItems: 'center' }}>Send your doubts or request and we will answer it!</Text>
                        <View style={{flex:6,borderColor:"blue",borderWidth:2,marginLeft:20,marginRight:20,borderRadius:20,backgroundColor:"white",}}>
                     
                        <Text style={{ marginLeft: 10 , color: '#000080', marginTop: 10, marginBottom: 5, fontSize: 15, fontWeight: 'bold', alignItems: 'center' }}>Forums:</Text>
