      ...
      let listItemView = (item) => {
        return (
          <View
            ...
            <Button mode="contained"  style={styles.stylebutton} onPress={() => Linking.openURL('https://www.google.com/intl/en_in/drive/')}>View Assignment</Button>
            <Button mode="contained"  style={styles.stylebutton} onPress={() => Linking.openURL('https://www.google.com/intl/en_in/drive/')}>Submit Assignment</Button>
